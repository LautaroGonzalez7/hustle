        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 m-card" style="margin-bottom: 2rem">
                    ...
                    <p>Recibimos tu pedido, ahora te dejamos nuestro código QR para que realices el pago.</p>
                    <p>Deberás pagar: PEN ${{$totalPrice}}</p>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 justify-content-center">
                            <div class="m-card payment-card text-center">
                                <div>
                                    <img src="{{asset('/assets/img/qr-example.png')}}" class="card-img-top"
                                         width="250px">
                                </div>
                            </div>
                        </div>
